...
Ni
- Focus on realizing ideals (how people live up to their potential) and convergent thinking
...
- Tend to focus on *action*, where they’ll do something, observe results, and immediately make a physical readjustment and try again 
...
- Seeks stability, security and familiarity, making decisions off personal priorities, passions, and commitments 
- Typically calm and has good self-control
...
- Keeps a structural approach, keeping a framework of order to make planes and establish routines 

Examples: Malcolm X, Michelle Obama, Mike Wazowski (from Monsters, Inc.)

Ti
- Develop their own complex internal frameworks, constantly comparing new information to their systems 
