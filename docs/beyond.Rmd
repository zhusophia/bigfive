...
In 1994, Cloninger, Svrakic, and Przybeck set out to create a psychobiological model of “temperament and character”, focusing on four traits that are moderately stable throughout one’s lifetime. If you recall, temperament and personality are slightly different, but the Big Five aims to incorporate temperament when considering personality. 

There are four confirmed traits of temperament: 
Novelty seeking
Harm avoidance 
Reward dependence 
Persistence 

These traits are all heritable, manifest early in life, and develop from perceptual memory and habits. 

https://www.researchgate.net/publication/14947976_Cloninger_CR_Svrakic_DM_Przybeck_TR_A_psychobiological_model_of_temperament_and_character_Arch_Gen_Psychiatry_50_975-990


It should be noted that extraversion is “genetically heterogeneous”, where changes in various genes such as ZNF180 can affect extravertism.  However, Eysenck makes the assumption that genetic and environmental infleunce behaviour in the same way — 

Concluded that “Eynsenck’s model was unaccapble” 

Four big trait,
Cloninger and Svraki
  Harm Avoidance  -  Novelty Seeking  -  Reward Dependence  -  Persistence
Biopsychoological model where the big for traits are moderately stable throughout life 

(Alternative) Big Five
Impulsive sensation seeking, aggression-hostility, activity, sociability, neuroticism-anxiety
Does not include an equivalent to openness to experience 

https://en.wikipedia.org/wiki/Alternative_five_model_of_personality#:~:text=The%20alternative%20five%20model%20of,%2C%20and%20activity%20(Act).
https://psycnet.apa.org/record/2002-17260-016


https://psycnet.apa.org/record/2005-01874-005

Big Six Traits (HEXACO)
Big five + honest-humility 
Attempts to provide a broader view of personality by expanding traits to include religiosity 
...
Used for personality spychpathology 

https://www.sciencedirect.com/science/article/abs/pii/S0191886920301914
https://www.researchgate.net/publication/335834113_Big_Five_Traits_A_Critical_Review
