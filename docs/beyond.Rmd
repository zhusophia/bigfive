...
This is further explored by using lexical hypothesis in Chinese, replicating the origins of the Big Five in Western countries. After utilizing the lexical hypothesis, researchers created a completely different quiz with different traits. 

In fact, let’s look at the Chinese Personality Assessment Inventory (CPAI), containing four major personality factors
Social potency (leadership, divergent thinking, novelty, extraversion)
Dependability (responsibility, optimism vs pessimism, face^[The public image you project - your ‘face’ in society.], locus of control) 
Accommodation (Family orientation, self vs society, defensiveness, graciousness, logical vs affective orientation) 
Interpersonal relatedness (individual vs social, harmony, discipline, traditionalism vs modernity)
...
Accommodation corresponds to agreeableness
 ...
 ‘Openness’ is no longer a category due to China’s collectivistic 


similar results can be found when using Arabic language and culture. In fact, differences were prominent enough to birth a completely new sixth trait: religiosity. 
...
Assuming that we continue to use an ‘etic’ or an universal approach, various studies have shown differing results, decreasing the reliability of the Big Five as a universal measuring tool of personality. 
