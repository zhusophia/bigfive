...
Now, we can combine everybody's letters from each personality traits to form their final result, then see which results are the most common within this data set. 
