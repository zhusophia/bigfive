...
- CSN = Neuroticsm (L/C)
- EST = Organization (O/U) <!-- have i gotten these mixed up?? est shoudl be emotional stability e.g. neuroticsm--> 
...
## https://stackoverflow.com/questions/52822840/ggplot2-create-a-barplot-for-every-column-of-a-dataframe

ggplot(data=ext4p, aes(x=Answers)) +
   geom_bar(fill="steel blue") +
   labs(
     title = "I am relaxed most of the time.",
     subtitle = "Hey! Stress hasn't caught up too much yet!") + 
...
ggplot(data=agr1p, aes(x=Answers)) +
   geom_bar(fill="steel blue") +
   labs(
     title = "I am relaxed most of the time.",
     subtitle = "Hey! Stress hasn't caught up too much yet!") + 
...
ggplot(data=ext8p, aes(x=Answers)) +
   geom_bar(fill="steel blue") +
   labs(
     title = "I am relaxed most of the time.",
     subtitle = "Hey! Stress hasn't caught up too much yet!") + 
...
ggplot(data=est8p, aes(x=Answers)) +
   geom_bar(fill="steel blue") +
   labs(
     title = "I am relaxed most of the time.",
     subtitle = "Hey! Stress hasn't caught up too much yet!") + 
...
ggplot(data=csn2p, aes(x=Answers)) +
   geom_bar(fill="steel blue") +
   labs(
     title = "I am relaxed most of the time.",
     subtitle = "Hey! Stress hasn't caught up too much yet!") + 
...
- get through data (question results, see if you can put all the questions side by side, then grab the funniest ones..?), start research for further analysis 

- data for each question -> https://www.kaggle.com/code/gchnfgxj/big-five-personalities-factor-analysis 
