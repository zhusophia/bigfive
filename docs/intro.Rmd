...
7. [Defintions](beyond.html#definitions)
8. [Origins](beyond.html#origins) 
9. [Strengths](beyond.html#strengths)
10. [Limitations](beyond.html#limitations)
11. [Applications in Society](beyond.html#applications)
12. [Potential Improvements](beyond.html#improvements)
13. [Spin-off Models](beyond.html#spinoff)
14. [Connections to (Jungian) MBTI](beyond.html#mbti)
15. [Beyond 'Beyond the Dataset'](beyond.html#future)
...
The Big Five is a personality model that categories people with 5 major personality traits:^[<a href="https://en.wikipedia.org/wiki/Big_Five_personality_traits" target="_blank">Wikipedia, *Big Five personality traits*.</a>] 
...
### Congrats! That's all the context you need :)
